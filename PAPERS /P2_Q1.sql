...
SELECT e.FIRST_NAME AS EMP_NAME FROM EMPLOYEES e JOIN DEPARTMENTS d ON d.DEPARTMENT_ID=e.DEPARTMENT_ID WHERE e.SALARY > ANY (SELECT
...
SELECT e.FIRST_NAME AS EMP_NAME, e.HIRE_DATE, m.FIRST_NAME AS MANAGER_NAME, m.HIRE_DATE AS MANAGER_HIRE_DATE FROM EMPLOYEES e LEFT JOIN EMPLOYEES m ON m.EMPLOYEE_ID=e.MANAGER_ID;
SELECT e.FIRST_NAME AS EMP_NAME FROM EMPLOYEES e WHERE e.SALARY < (
